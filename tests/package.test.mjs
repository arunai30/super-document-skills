...
const skillNames = ["create-client-decision-brief", "create-html-presentation", "create-project-management-artifact", "create-visual-explainer", "create-visual-report", "create-workflow-diagram"];

test("six complete, independently copyable skill packages", async () => {
